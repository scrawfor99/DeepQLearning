...
five_comparisons_1_in = baseline_in['Portfolio']
five_comparisons_1_in.name = 'Baseline'

five_comparisons_1_out = baseline_in['Portfolio']
five_comparisons_1_out.name = 'Baseline'
...
for combo in itertools.combinations(range(2, 7), 4):
    ...
    five_comparisons_1_out = pd.concat([five_comparisons_1_out, port_out], axis=1)
    ...
    five_comparisons_1_in = pd.concat([five_comparisons_1_in, port_in], axis=1)
...
name = '/home/scrawfor/Link_to_ML/FML/Five_Indicator_1_out_Results.csv'
five_comparisons_1_out.to_csv(name, index=True)
name = '/home/scrawfor/Link_to_ML/FML/Five_Indicator_1_in_Results.csv'
five_comparisons_1_in.to_csv(name, index=True)



five_comparisons_2_in = baseline_in['Portfolio']
five_comparisons_2_in.name = 'Baseline'

five_comparisons_2_out = baseline_in['Portfolio']
five_comparisons_2_out.name = 'Baseline'
...
for c in combo:
    ...
    combo_name += " & "
port_out.name = combo_name[:-3]
five_comparisons_2_out = pd.concat([five_comparisons_2_out, port_out], axis=1)
...
for c in combo:
    ...
    combo_name += " & "
port_in.name = combo_name[:-3]
five_comparisons_2_in = pd.concat([five_comparisons_2_in, port_in], axis=1)
...
name = '/home/scrawfor/Link_to_ML/FML/Five_Indicator_2_out_Results.csv'
five_comparisons_2_out.to_csv(name, index=True)

name = '/home/scrawfor/Link_to_ML/FML/Five_Indicator_2_in_Results.csv'
five_comparisons_2_in.to_csv(name, index=True)


six_comparisons_in = baseline_in['Portfolio']
six_comparisons_in.name = 'Baseline'

six_comparisons_out = baseline_out['Portfolio']
six_comparisons_out.name = 'Baseline'
...
for combo in itertools.combinations(range(7), 6):
    ...
    for c in combo:
        ...
        combo_name += " & "
    port_out.name = combo_name[:-3]
    six_comparisons_out = pd.concat([six_comparisons_out, port_out], axis=1)
    ...
    for c in combo:
        ...
        combo_name += " & "
    port_in.name = combo_name[:-3]
    six_comparisons_in = pd.concat([six_comparisons_in, port_in], axis=1)

    # Out of sample.  Only do this once you are fully satisfied with the in sample performance!
    #env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 


name = '/home/scrawfor/Link_to_ML/FML/Six_Indicator_in_Results.csv'
six_comparisons_in.to_csv(name, index=True)
name = '/home/scrawfor/Link_to_ML/FML/Six_Indicator_out_Results.csv'
six_comparisons_out.to_csv(name, index=True)

seven_comparisons_in = baseline_in['Portfolio']
seven_comparisons_in.name = 'Baseline'
seven_comparisons_out = baseline_out['Portfolio']
seven_comparisons_out.name = 'Baseline'
...
for c in combo:
    ...
    combo_name += " & "
port_out.name = combo_name[:-3]
seven_comparisons_out = pd.concat([seven_comparisons_out, port_out], axis=1)
...
for c in combo:
    ...
    combo_name += " & "
port_in.name = combo_name[:-3]
seven_comparisons_in = pd.concat([seven_comparisons_in, port_in], axis=1)

# Out of sample.  Only do this once you are fully satisfied with the in sample performance!
#env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 


name = '/home/scrawfor/Link_to_ML/FML/Seven_Indicator_out_Results.csv'
seven_comparisons_out.to_csv(name, index=True)
name = '/home/scrawfor/Link_to_ML/FML/Seven_Indicator_in_Results.csv'
seven_comparisons_in.to_csv(name, index=True)