...
four_comparisons_0_in = baseline_in['Portfolio']
four_comparisons_0_in.name = 'Baseline'
four_comparisons_0_out = baseline_out['Portfolio']
four_comparisons_0_out.name = 'Baseline'
...
for combo in itertools.combinations(range(1, 7), 3):
    ...
    four_comparisons_0_out = pd.concat([four_comparisons_0_out, port_out], axis=1)
    ...
    four_comparisons_0_in = pd.concat([four_comparisons_0_in, port_in], axis=1)
...
name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_0_out_Results.csv'
four_comparisons_0_out.to_csv(name, index=True)


name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_0_in_Results.csv'
four_comparisons_0_in.to_csv(name, index=True)