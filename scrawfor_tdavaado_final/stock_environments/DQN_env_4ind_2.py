...
four_comparisons_1_in = baseline_in['Portfolio']
four_comparisons_1_in.name = 'Baseline'
four_comparisons_1_out = baseline_out['Portfolio']
four_comparisons_1_out.name = 'Baseline'
...
for combo in itertools.combinations(range(2, 7), 3):
    ...
    four_comparisons_1_out = pd.concat([four_comparisons_1_out, port_out], axis=1)
    ...
    four_comparisons_1_in = pd.concat([four_comparisons_1_in, port_in], axis=1)
...
name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_1_in_Results.csv'
four_comparisons_1_in.to_csv(name, index=True)
name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_1_out_Results.csv'
four_comparisons_1_out.to_csv(name, index=True)


four_comparisons_2_in = baseline_in['Portfolio']
four_comparisons_2_in.name = 'Baseline'

four_comparisons_2_out = baseline_out['Portfolio']
four_comparisons_2_out.name = 'Baseline'
...
for combo in itertools.combinations(range(3, 7), 3):
    ...
    for c in combo:
        ...
        combo_name += " & "
    port_out.name = combo_name[:-3]
    four_comparisons_2_out = pd.concat([four_comparisons_2_out, port_out], axis=1)
    ...
    for c in combo:
        ...
        combo_name += " & "
    port_in.name = combo_name[:-3]
    four_comparisons_2_in = pd.concat([four_comparisons_2_in, port_in], axis=1)

    # Out of sample.  Only do this once you are fully satisfied with the in sample performance!
    #env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 


name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_2_in_Results.csv'
four_comparisons_2_in.to_csv(name, index=True)
name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_2_out_Results.csv'
four_comparisons_2_out.to_csv(name, index=True)

four_comparisons_3_in = baseline_in['Portfolio']
four_comparisons_3_in.name = 'Baseline'
four_comparisons_3_out = baseline_out['Portfolio']
four_comparisons_3_out.name = 'Baseline'
...
for c in combo:
    ...
    combo_name += " & "
port_out.name = combo_name[:-3]
four_comparisons_3_out = pd.concat([four_comparisons_3_out, port_out], axis=1)
...
for c in combo:
    ...
    combo_name += " & "
port_in.name = combo_name[:-3]
four_comparisons_3_in = pd.concat([four_comparisons_3_in, port_in], axis=1)

# Out of sample.  Only do this once you are fully satisfied with the in sample performance!
#env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 


name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_3_in_Results.csv'
four_comparisons_3_in.to_csv(name, index=True)
name = '/home/scrawfor/Link_to_ML/FML/Four_Indicator_3_out_Results.csv'
four_comparisons_3_out.to_csv(name, index=True)