...
five_comparisons_0_in = baseline_in['Portfolio']
five_comparisons_0_in.name = 'Baseline'
five_comparisons_0_out = baseline_out['Portfolio']
five_comparisons_0_out.name = 'Baseline'
...
for combo in itertools.combinations(range(1, 7), 4):
    ...
    five_comparisons_0_out = pd.concat([five_comparisons_0_out, port_out], axis=1)
    ...
    five_comparisons_0_in = pd.concat([five_comparisons_0_in, port_in], axis=1)
...
name = '/home/scrawfor/Link_to_ML/FML/Five_Indicator_0_out_Results.csv'
five_comparisons_0_out.to_csv(name, index=True)

name = '/home/scrawfor/Link_to_ML/FML/Five_Indicator_0_in_Results.csv'
five_comparisons_0_in.to_csv(name, index=True)